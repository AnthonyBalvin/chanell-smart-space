...
const steps = [
  { icon: MousePointer, title: "Elige tu equipo", desc: "Explora nuestro catálogo y elige el producto ideal." },
  { icon: ShoppingCart, title: "Agrégalo al carrito", desc: "Añade los productos que te gusten al carrito." },
  { icon: CreditCard, title: "Presiona pagar", desc: "Revisa tu pedido y confirma la compra." },
  { icon: MessageCircle, title: "Pedido por WhatsApp", desc: "Tu pedido se envía automáticamente a WhatsApp." },
];
        ...
        <div className="grid md:grid-cols-4 gap-8">
          {steps.map((step, i) => (
            <div key={step.title} className="text-center relative">
              ...
              <span className="text-xs font-bold text-primary mb-2 block">Paso {i + 1}</span>
